...
usam `conteudo/alunos.yaml`, com suporte a fotos circulares e símbolos das
...
e os alunos têm um cadastro compartilhado em `alunos.yaml`. Para acrescentar um
...
| `conteudo/alunos.yaml` | Alunos, temas, situação, nível, fotos e símbolos institucionais |
